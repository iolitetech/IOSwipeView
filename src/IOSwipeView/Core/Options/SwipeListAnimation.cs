...
public enum ListDeleteStyle : byte
{
    ...
    /// <summary>Row scales down while sliding off-screen to the left.</summary>
    ShrinkSlideLeft,

    /// <summary>Row scales down while sliding off-screen to the right.</summary>
    ShrinkSlideRight,

    /// <summary>Row scales down and fades out while collapsing height.</summary>
    ScaleDown,

    /// <summary>Row pops slightly outward and collapses with a fade.</summary>
    PopOut,

    /// <summary>Row tilts with perspective fold while collapsing height.</summary>
    CardFold,

    /// <summary>Row dissolves to opacity 0 while collapsing height.</summary>
    Fade,
...
/// <param name="Curve">CSS timing curve. Defaults to <c>cubic-bezier(0.16, 1, 0.3, 1)</c>.</param>
...
{
    /// <summary>Default spring height collapse animation (~320ms).</summary>
    public static SwipeListAnimation Default { get; } = new(ListDeleteStyle.AppleSpring, 320);

    /// <summary>Spring collapse (~320ms).</summary>
    ...
    /// <summary>Shrink scale and slide off-screen left (~320ms).</summary>
    public static SwipeListAnimation ShrinkSlideLeft { get; } = new(ListDeleteStyle.ShrinkSlideLeft, 320, "cubic-bezier(0.2, 0.9, 0.3, 1)");

    /// <summary>Shrink scale and slide off-screen right (~320ms).</summary>
